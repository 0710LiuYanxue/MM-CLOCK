...
def process_csv():
    ...
    # algos = ["EACLOCK","EACLOCK-FDW","newalgo","ARC","WATT","2Q","S3-FIFO","LIRS","Hyperbolic","LeanEvict","LRU-2","Clock Sweep","lru","CLOCK","Random"]
    # algos = ["EACLOCK","EACLOCK-FDW","newalgo 24","ARC","WATT","2Q","S3-FIFO","LIRS","Hyperbolic","LeanEvict","LRU-2","Clock Sweep","lru","CLOCK","Random"]
    # algos = ["EACLOCK","newalgo 1","newalgo 2","newalgo 4","newalgo 8","newalgo 10","newalgo 12","newalgo 16","newalgo 20","newalgo 24","S3-FIFO","WATT","Random"]
    # algos = ["EACLOCK","EACLOCK-FDW","opt","ARC","WATT","2Q","S3-FIFO","LIRS","W-TinyLFU","TinyLFU_3","LRU-2","lru","CLOCK", "Clock Sweep","Hyperbolic","LeanEvict","Random"]
    algos = ["EACLOCK","EACLOCK-FDW","opt","W-TinyLFU","ARC","WATT","2Q","S3-FIFO","LIRS","LRU-2","lru","CLOCK", "Clock Sweep","Hyperbolic","LeanEvict","Random"]
