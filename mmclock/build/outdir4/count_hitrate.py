...
def process_csv():
    ...
    #algos = ["EACLOCK","newalgo 1","newalgo 2","newalgo 24","newfinal","S3-FIFO","LIRS","WATT","lru","Random"]
    algos = ["EACLOCK","EACLOCK-FDW","EACLOCK-FWA","ARC","WATT","2Q","S3-FIFO","LIRS","LRU-2","Hyperbolic","LeanEvict","Clock Sweep","lru","CLOCK","Random"]
